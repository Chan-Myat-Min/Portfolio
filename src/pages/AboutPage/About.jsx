...
const About = () => {
  ...
  return (
    <div className="about ab_main relative" id="about">
      <p className="uppercase ab_header" data-aos="fade-right">
        About me
      </p>
      <div className="mt-10 md:mt-20 flex flex-col lg:flex-row gap-10">
        ...
        <div className="w-full lg:w-1/2" data-aos="zoom-in">
          <p className="text-[18px] mt-3 text-[#666]">
            <span className="text-kayan font-medium text-[20px]">{`<p>`}</span>{" "}
            Hello, my name’s{" "}
            <span className="font-bold text-[19px] text-black">
              Chan Myat Min
            </span>{" "}
            . I am a fullstack developer based in Myanmar and I have been
            employing as web developer since 2019. <br />
      ...
      <div
        className="flex py-5 md:mx-auto bg-white shadow-lg w-[100%] md:w-[70%] bottom-[0%] left-[15%] rounded-[8px] mt-5 xl:mt-20"
        data-aos="zoom-in"
      >
