        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          <div className="" data-aos="zoom-in">
            ...
            <ul className="mt-3 leading-loose text-[#c5c4c4]">
              <li>Email : chanmyatmin120@gmail.com</li>
              <li>Phone : +959781534466</li>
          ...
          <div
            className="flex md:flex-col gap-8 md:gap-3 justify-center md:items-end"
            data-aos="zoom-in"
          >
            <a
              href="https://www.facebook.com/justicvenny.chanlay"
              className="w-[40px] md:w-[200px] h-[40px] bg-white rounded-full flex items-center cursor-pointer text-black hover:text-kayan transition-all duration-200"
            >
              <FaFacebook size={25} className="ml-2 md:ml-3" />
              <span className="text-black hidden md:block md:ml-3 text-[18px] cursor-pointer">
                Facebook
              </span>
            </a>
            <a
            ...
            <a
              href="https://github.com/Chan-Myat-Min"
              className="w-[40px] md:w-[200px] h-[40px] bg-white rounded-full flex items-center cursor-pointer text-black hover:text-kayan transition-all duration-200"
            >
