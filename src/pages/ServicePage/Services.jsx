...
const servicesData = [
  {
    ...
    description:
      "Responsive design is an important thing in media devices. I can create responsive designs for mobile, tablet , computer and desktop.",
  ...
  },
  {
    ...
    title: "Clean Code",
    description:
      "I can write clean codes and reuseable codes. And it is easy to understand and to reuse that other developers .",
  ...
  },
  {
    ...
    description:
      "Lorem Ipsum is simply dummy text of the printing simply dummy text of the printing and typesetting industry.",
  ...
  },
  {
    ...
    description:
      "UI is an important thing for users. And it is also need to friendly with user. Don't worry for it. I can provide the best for UI",
...
const Services = () => {
  ...
  return (
    <div className="service flex flex-col justify-center" id="services">
      <h3
        className="sv_header font-semibold text-[20px] uppercase"
        data-aos="fade-right"
      >
        Services
      </h3>
      <div className="mt-14 lg:mt-5">
        <h2
          className="text-center font-semibold text-[20px] md:text-[25px] text-black uppercase"
          data-aos="zoom-in"
        >
          What I Can Do
        </h2>
      ...
      <div className="mt-14 lg:mt-20">
        <h4
          className="text-center uppercase text-[20px] md:text-[25px] font-semibold text-black"
          data-aos="zoom-in"
        >
