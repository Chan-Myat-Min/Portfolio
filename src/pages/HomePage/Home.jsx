      ...
      <div className="h_main mt-10 md:mt-20 lg:mt-0">
        <div className="flex flex-col">
          <p className="font-semibold text-[30px]">
            I am <span className="text-[32px] text-kayan">C</span>han Myat Min
          </p>
          ...
          <div className="flex gap-3 mt-5">
            <a href="tel:09781534466" className="h_btn">
              Hire me
            </a>
      ...
      <div className="h_main justify-center">
        <div className="relative w-[250px] h-[250px] md:w-[300px] md:h-[300px]">
          ...
          <img
            src={cvImg}
            alt=""
            className="w-[100%] h-[100%] rounded-full border-[5px] border-black absolute z-20 shadow-lg animate__animated animate__bounceIn object-contain"
          />
